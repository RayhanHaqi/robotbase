...
typedef enum
{
  ...
  back = 6, //stop
  start = 7, //start
  putar_kiri = 10, //belok kiri
  putar_kanan = 9, //belok kanan
  reset_posisi = 8, //reset posisi
...
//start robot
  if (myControler.button[start] == 0 && myControler.prev_button[start] == 1)
  {
    status_control ^= 1;
  }

  myControler.prev_button[start] = myControler.button[start];

//robot maju
  if (myControler.button[Y] == 0 && myControler.prev_button[Y] != 0)
    {
        robotSpeed[0] = 0;
        robotSpeed[1] = 5;
        robotSpeed[2] = 0;
    } 
  myControler.prev_button[Y] = myControler.button[Y];

//robot mundur
  if (myControler.button[A] == 0 && myControler.prev_button[A] != 0)
    {
        robotSpeed[0] = 0;
        robotSpeed[1] = -5;
        robotSpeed[2] = 0;
    }
  myControler.prev_button[A] = myControler.button[A];

//robot geser kanan
  if (myControler.button[B] == 0 && myControler.prev_button[B] != 0)
    {
        robotSpeed[0] = 5;
        robotSpeed[1] = 0;
        robotSpeed[2] = 0;
    }
  myControler.prev_button[B] = myControler.button[B];

//robot geser kiri
  if (myControler.button[X] == 0 && myControler.prev_button[X] != 0)
    {
        robotSpeed[0] = -5;
        robotSpeed[1] = 0;
        robotSpeed[2] = 0;
    }
  myControler.prev_button[X] = myControler.button[X];

//robot putar kiri
  if (myControler.button[putar_kiri] == 0 && myControler.prev_button[putar_kiri] != 0)
    {
        robotSpeed[0] = 0;
        robotSpeed[1] = 0;
        robotSpeed[2] = -5;
    }
    myControler.prev_button[putar_kiri] = myControler.button[putar_kiri];

//robot putar kanan
  if (myControler.button[putar_kanan] == 0 && myControler.prev_button[putar_kanan] != 0)
    {
        robotSpeed[0] = 0;
        robotSpeed[1] = 0;
        robotSpeed[2] = 5;
    }
    myControler.prev_button[putar_kanan] = myControler.button[putar_kanan];

//reset odometry
  if (myControler.button[reset_posisi] == 0 && myControler.prev_button[reset_posisi] != 0)
    {
  ...
  myControler.prev_button[reset_posisi] = myControler.button[reset_posisi];
  ...
  if (n > 10)
  {
    ...
    if (data_len == 4 && sLocal[0].length() > 3)
    {
     ...
     // positionFiltered[2] = buffPosZFilter[2];
      ...
      positionFiltered[0] = -0.1287+0.6901*buffPosXFilter[2]+0.0001*buffPosXFilter[2]*2 ;
      positionFiltered[1] = -0.1006+0.7213*buffPosYFilter[2]-0.0001*buffPosYFilter[2]*2 ;
      positionFiltered[2] = -0.1401+1.0043*buffPosZFilter[2]+0.0*buffPosZFilter[2]*2 ;
